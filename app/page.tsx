  ...
  return (
    <>
      ...
      <main className="px-5 pb-10 pt-6 md:px-8 md:pb-12">
        <section className="app-surface app-hero w-full overflow-hidden rounded-[20px] p-8 md:p-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/documents"
              className="inline-flex items-center rounded-xl bg-slate-900 px-5 py-3 text-sm font-medium text-white shadow-lg shadow-slate-900/20 hover:-translate-y-0.5 hover:bg-slate-800"
            >
              Go to documents
            </Link>
            <div className="inline-flex items-center rounded-xl border border-white/60 bg-white/60 px-5 py-3 text-sm font-medium text-slate-700">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={title}
                className="rounded-[16px] border border-white/60 bg-white/70 p-5"
              >
